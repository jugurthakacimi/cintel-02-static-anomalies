"""
anomaly_detector_jugurtha.py - Project script.
...
DATA_FILE: Final[Path] = DATA_DIR / "clinic_data_jugurtha.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "anomalies_jugurtha.csv"
...
def main() -> None:
    ...
    LOG.info("Studying adults's ages and heights to find anomalies...")

    # x is age in years, so 95 is the upper limit for adults
    MAX_REASONABLE_X_VALUE: Final[float] = 95.0
    ...
    # We will use greater than or equal to (>) to find values above the threshold.
